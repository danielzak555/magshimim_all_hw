...
#מה שהפונקציה עושה זה לבדוק האם האנשים שנפגעים הם נפגעים מבחירה
#כי יש להם את הזכות לחיים ביטחון ושיוויון ואתה לא יכול להחליט בשבילם

def isMoral(behavior):
    byChoise = input("is the people who suffer, will suffer by choise?\n")
    return byChoise.lower == "yes"
